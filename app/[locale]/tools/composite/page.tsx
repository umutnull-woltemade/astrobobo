...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return { title: isEn ? "Composite Chart — Relationship Midpoint" : "Kompozit Harita — İlişki Orta Noktası",
    description: isEn ? "Calculate the composite chart (midpoints) of two birth charts. Swiss Ephemeris precision." : "İki doğum haritasının kompozit haritasını (orta noktalar) hesaplayın. Swiss Ephemeris hassasiyeti.",
...
export default async function CompositePage({ params }: PageProps) {
  ...
  return (<div className="max-w-4xl mx-auto px-4 py-12">
    <ToolBreadcrumbs toolName={isEn ? "Composite Chart" : "Kompozit Harita"} toolSlug="composite" locale={locale as string} />

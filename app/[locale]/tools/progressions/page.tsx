...
export default async function ProgressionsPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ToolBreadcrumbs toolName={isEn ? "Secondary Progressions" : "İkincil Progresyonlar"} toolSlug="progressions" locale={locale as string} />
      ...
      <MoreTools currentSlug="progressions" locale={locale as string} localePath={localePath} />
    </div>
  );
}

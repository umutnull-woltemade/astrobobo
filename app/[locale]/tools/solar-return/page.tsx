...
export default async function SolarReturnPage({ params }: PageProps) {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <ToolBreadcrumbs toolName={isEn ? "Solar Return" : "Solar Return"} toolSlug="solar-return" locale={locale as string} />
      ...
      <MoreTools currentSlug="solar-return" locale={locale as string} localePath={localePath} />
    </div>
  );
}
